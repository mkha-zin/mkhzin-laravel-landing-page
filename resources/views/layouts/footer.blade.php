@php
    ...
    $twitter = \App\Models\SocialLink::query()->where('title_en', 'Twitter')->where('is_active', 1)->first();
...
<footer itemscope="itemscope" itemtype="https://schema.org/WPFooter">
    <div data-elementor-type="wp-post" data-elementor-id="1061" class="elementor elementor-1061">
        <div class="elementor-element elementor-element-a086e98 e-flex e-con-boxed e-con e-parent"
             data-element_type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
            <div class="e-con-inner">
                <div class="elementor-element elementor-element-f44d8b9 e-con-full e-flex e-con e-child"
                     data-element_type="container">
                    <div class="elementor-element elementor-element-e45eece elementor-widget elementor-widget-image"
                    ...
                    <div
                        class="elementor-element elementor-element-0854186 e-grid-align-left e-grid-align-mobile-center elementor-shape-rounded elementor-grid-0 elementor-widget elementor-widget-social-icons"
                                    ...
                                    <span class="elementor-grid-item">
                                        <a href="{{  $snapchat->link }}"
                                           ...
                                           target="_blank">
                                            ...
                                            <svg class="e-font-icon-svg e-fab-snapchat" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                @endif
                                    ...
                                    @if(!empty($whatsChannel))
                                        ...
                                        <a href="{{  $whatsChannel->link }}"
                                           ...
                                           target="_blank">
                                            <span class="elementor-screen-only">
                                                {{ $direction == 'rtl' ? $whatsChannel->title_ar : $whatsChannel->title_en }}
                                            </span>
                ...
                <div class="elementor-element elementor-element-bcb0e83 e-con-full e-flex e-con e-child"
                    ...
                    <div
                        ...
                        <div class="elementor-widget-container">
                            <h3 class="elementor-heading-title elementor-size-default">{{ __('landing.Quick Links') }}</h3>
                        </div>
                    </div>
                    <div
                        class="elementor-element elementor-element-e6423b9 elementor-align-left elementor-mobile-align-center elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                        data-id="e6423b9" data-element_type="widget" data-widget_type="icon-list.default">
                        <div class="elementor-widget-container">
                ...
                @if(!empty($sections))
                    <div class="elementor-element elementor-element-403ecc6 e-con-full e-flex e-con e-child"
                        ...
                        <div
                            ...
                            <div class="elementor-widget-container">
                                <h3 class="elementor-heading-title elementor-size-default">{{ __('landing.Departments') }}</h3>
                            </div>
                        </div>
                        <div
        ...
        <div class="elementor-element elementor-element-43bbb4d e-flex e-con-boxed e-con e-parent" data-id="43bbb4d"
             data-element_type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
            <div class="e-con-inner">
                <div class="elementor-element elementor-element-0097140 elementor-widget elementor-widget-heading"
