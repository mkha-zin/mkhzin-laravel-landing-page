                ...
                <nav class="navbar navbar-dark navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="navbar-nav {{ $direction == 'rtl' ? 'mr-auto' : 'ml-auto' }}">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="#gallery">{{ __('landing.gallery') }}</a> </li>
                            <li class="nav-item"> <a class="nav-link" href="#pricing">{{ __('landing.Store') }}</a> </li>
                            <li class="nav-item"> <a href="#download" class="btn btn-outline-light my-3 my-sm-0 ml-lg-3">{{ __('landing.Download') }}</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
...
<header class="bg-gradient" id="home">
    <div class="container mt-5">
        <h1>مرحباً بك في المتجر الإلكتروني</h1>
        <p class="tagline">
             توفر شركة مخازن المملكة العالمية متجراً الكترونياً يسهل على عملائها طلب كل ما يحبون من أماكنهم دون الحاجة لتكبد عناء التسوق بالطريقة العادية.
        </p>
    </div>
    <div class="img-holder mt-3"><img src="{{ asset('store/images/iphonex.png') }}" alt="phone" class="img-fluid"></div>
</header>

<div class="client-logos my-5">
    <div class="container text-center">
        <img src="{{ asset('store/images/client-logos.png') }}" alt="client logos" class="img-fluid">
    </div>
</div>
...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="perspective-phone">
            <img src="{{ asset('store/images/perspective.png') }}" alt="perspective phone" class="img-fluid">
        </div>
    </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="communication">
                <div class="d-flex flex-column flex-lg-row">
                    <img src="{{ asset('store/images/graphic.png') }}" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                    <div>
...
<div class="section">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('store/images/dualphone.png') }}" alt="dual phone" class="img-fluid">
            </div>
...
<div class="section light-bg">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="{{ asset('store/images/iphonex.png') }}" alt="iphone" class="img-fluid">
            </div>
    ...
    <div class="container">
        ...
        <div class="testimonials owl-carousel">
            <div class="testimonials-single">
                <img src="{{ asset('store/images/client.png') }}" alt="client" class="client-img">
    ...
    <div class="container">
        <div class="call-to-action">
            ...
            <div class="my-4">
                ...
                <a href="#" class="btn btn-light"><img src="{{ asset('store/images/appleicon.png') }}" alt="icon"> App Store</a>
                <a href="#" class="btn btn-light"><img src="{{ asset('store/images/playicon.png') }}" alt="icon"> Google play</a>
            </div>
