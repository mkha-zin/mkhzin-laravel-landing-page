...
<head>
    ...
    <meta name="keywords"
          content="Store, E-Commerce, eshop, delivery, mkhazin, mkhzin, makhazin, order, online, store, shopping, ecommerce, makhazin, grocery, grocery store, grocery online, online grocery">
            ...
            <div class="col-lg-6">
                <div class="social-icons">
                    <div class="social-icons1">
                        ...
                        <!-- Tiktok -->
                        @if(!empty($tiktok))
                            <a href="{{ $tiktok->link }}" target="_blank" style="margin-left: 1px; margin-right: 1px;">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                    <path
                        ...
                        <!-- Twitter X -->
                        @if(!empty($twitter))
                            <a href="{{ $twitter->link }}" target="_blank" style="margin-left: 1px; margin-right: 1px;">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path
                        ...
                        <!-- Youtube -->
                        @if(!empty($youtube))
                            <a href="{{ $youtube->link }}" target="_blank" style="margin-left: 1px; margin-right: 1px;">
